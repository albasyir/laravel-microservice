...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This is the private key used to sign JWT tokens. It should be stored
    | securely in your .env file and never committed to version control.
    |
    */
    'key' => env('JWT_KEY'),
    ...
    |--------------------------------------------------------------------------
    |
    | This is the public key used to verify JWT tokens. It should be stored
    | in your .env file.
    |
    */
